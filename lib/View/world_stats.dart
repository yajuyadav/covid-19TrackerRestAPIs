...
import 'package:covid_tracker/services/statsServices.dart';
...
class World_stats extends StatefulWidget {
  @override
  _World_statsState createState() => _World_statsState();
}
...
class _World_statsState extends State<World_stats> with TickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    statsService statservices= new statsService();
    return Scaffold(
      body: SafeArea(
        child: Padding(
